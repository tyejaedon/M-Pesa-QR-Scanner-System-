            ...
            <ResponsiveContainer width="100%" height="100%">
              {viewMode === 'bar' ? (
                ...
                <ComposedChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <Area type="monotone" dataKey="actualRevenue" stroke="none" fill="url(#orangeGradient)" />
          ...
          <div className="flex-1 w-full relative min-h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip formatter={(value) => `KES ${value.toLocaleString()}`} contentStyle={{ backgroundColor: '#18181b', borderRadius: '12px', border: '1px solid #27272a', color: '#fff' }} />
